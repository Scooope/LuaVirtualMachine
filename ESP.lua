...
if not h or not i or i.Health<=0 then return nil end
local j=h.Position
local k=5.0
...
return{X=v-u/2,Y=w,Width=u,Height=t}
end

-- Store the connection so we can disconnect it later
local renderConnection = b.RenderStepped:Connect(function()
...
-- Store connection globally so menu can disconnect it
_G.ESPConnection = renderConnection
...
print("[ESP] Loaded. Tracking "..#a:GetPlayers()-1 .." player(s).")
